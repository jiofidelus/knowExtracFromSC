...
/**
 * A data handler for the DistrictSante beans 
 * @author Medes-IMPS
 */
public class DistrictSanteHandler {
	...
	public DistrictSante findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public DistrictSante getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(DistrictSante entity, boolean isNew) {
	...
	/**
	 * Lists the entities of type DistrictSante
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of districtSante
	 */
	@Transactional(readOnly = true)
	public List<DistrictSante> listDistrictSante(String sortProperty,
			boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<DistrictSante> beans = dao.load(sortProperty, sortOrder, junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DistrictSante> listDistrictSante(int i, int j,
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<DistrictSante> beans = dao.load(i, j, sortProperty, sortOrder,
				junction);
	...
	/**
	 * Lists the non affected entities of type DistrictSante	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DistrictSante> listNonAffectedDistrictSante(int i, int j,
			String sortProperty, boolean sortOrder, ImogJunction criterions,
			String property) {
		...
		List<DistrictSante> beans = dao.loadNonAffected(i, j, sortProperty,
	...
	public List<DistrictSante> listNonAffectedDistrictSante(int i, int j,
		...
		return listNonAffectedDistrictSante(i, j, sortProperty, sortOrder,
				null, property);
	}

	/**
	 * Used when DistrictSante is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of DistrictSante non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DistrictSante> listNonAffectedDistrictSanteReverse(int i,
		...
		List<DistrictSante> beans = dao.loadNonAffectedReverse(i, j,
	...
	public List<DistrictSante> listNonAffectedDistrictSanteReverse(int i,
		...
		return listNonAffectedDistrictSanteReverse(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Gets an empty list of DistrictSante	
	 * @return an empty list of DistrictSante
	 */
	@Transactional(readOnly = true)
	public List<DistrictSante> getDistrictSanteEmptyList() {
		return new ArrayList<DistrictSante>();
	}

	/**
	 * Counts the number of districtSante in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countDistrictSante() {
		return countDistrictSante(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countDistrictSante(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected districtSante entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedDistrictSante(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedDistrictSante(String property) {
		return countNonAffectedDistrictSante(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedDistrictSanteReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedDistrictSanteReverse(String property) {
		return countNonAffectedDistrictSanteReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<DistrictSante> entities) {
		if (entities != null) {
			for (DistrictSante entity : entities)
				delete(entity);
		}
	}
	 ...
	 */
	@Transactional
	public void delete(DistrictSante entity) {
	...
	/**
	 * Lists the entities of type DistrictSante for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<DistrictSante> listForCsv(String sortProperty,
			boolean sortOrder, String region_nom_francais,
			String region_nom_english, String nom_francais, String nom_english) {
		...
		List<DistrictSante> beans = dao.load(sortProperty, sortOrder, junction);
		List<DistrictSante> securedBeans = filter
				.<DistrictSante> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the DistrictSante Dao
	 */
	public void setDao(DistrictSanteDao dao) {
		this.dao = dao;
	}
