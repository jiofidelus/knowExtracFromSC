...
/**
 * A data handler for the DetailCommandeIntrant beans 
 * @author Medes-IMPS
 */
public class DetailCommandeIntrantHandler {
	...
	public DetailCommandeIntrant findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public DetailCommandeIntrant getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(DetailCommandeIntrant entity, boolean isNew) {
	...
	/**
	 * Lists the entities of type DetailCommandeIntrant
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of detailCommandeIntrant
	 */
	@Transactional(readOnly = true)
	public List<DetailCommandeIntrant> listDetailCommandeIntrant(
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<DetailCommandeIntrant> beans = dao.load(sortProperty, sortOrder,
				junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DetailCommandeIntrant> listDetailCommandeIntrant(int i, int j,
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<DetailCommandeIntrant> beans = dao.load(i, j, sortProperty,
				sortOrder, junction);
	...
	/**
	 * Lists the non affected entities of type DetailCommandeIntrant	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DetailCommandeIntrant> listNonAffectedDetailCommandeIntrant(
		...
		List<DetailCommandeIntrant> beans = dao.loadNonAffected(i, j,
	...
	public List<DetailCommandeIntrant> listNonAffectedDetailCommandeIntrant(
			int i, int j, String sortProperty, boolean sortOrder,
			String property) {
		return listNonAffectedDetailCommandeIntrant(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Used when DetailCommandeIntrant is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of DetailCommandeIntrant non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DetailCommandeIntrant> listNonAffectedDetailCommandeIntrantReverse(
			int i, int j, String sortProperty, boolean sortOrder,
			ImogJunction criterions, String property) {
		...
		List<DetailCommandeIntrant> beans = dao.loadNonAffectedReverse(i, j,
				sortProperty, sortOrder, property, junction);
	...
	public List<DetailCommandeIntrant> listNonAffectedDetailCommandeIntrantReverse(
			int i, int j, String sortProperty, boolean sortOrder,
			String property) {
		return listNonAffectedDetailCommandeIntrantReverse(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Gets an empty list of DetailCommandeIntrant	
	 * @return an empty list of DetailCommandeIntrant
	 */
	@Transactional(readOnly = true)
	public List<DetailCommandeIntrant> getDetailCommandeIntrantEmptyList() {
		return new ArrayList<DetailCommandeIntrant>();
	}

	/**
	 * Counts the number of detailCommandeIntrant in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countDetailCommandeIntrant() {
		return countDetailCommandeIntrant(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countDetailCommandeIntrant(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected detailCommandeIntrant entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedDetailCommandeIntrant(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedDetailCommandeIntrant(String property) {
		return countNonAffectedDetailCommandeIntrant(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedDetailCommandeIntrantReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedDetailCommandeIntrantReverse(String property) {
		return countNonAffectedDetailCommandeIntrantReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<DetailCommandeIntrant> entities) {
		if (entities != null) {
			for (DetailCommandeIntrant entity : entities)
				delete(entity);
		}
	}
	 ...
	 */
	@Transactional
	public void delete(DetailCommandeIntrant entity) {
	...
	/**
	 * Lists the entities of type DetailCommandeIntrant for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<DetailCommandeIntrant> listForCsv(String sortProperty,
			boolean sortOrder, String intrant_identifiant,
			String quantiteRequise, String quantiteEnStock) {
		...
		List<DetailCommandeIntrant> beans = dao.load(sortProperty, sortOrder,
				junction);
		List<DetailCommandeIntrant> securedBeans = filter
				.<DetailCommandeIntrant> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the DetailCommandeIntrant Dao
	 */
	public void setDao(DetailCommandeIntrantDao dao) {
		this.dao = dao;
	}
