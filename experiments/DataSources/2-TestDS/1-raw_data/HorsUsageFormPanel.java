...
import org.imogene.epicam.client.ui.workflow.HorsUsageEditorWorkflow;
...
/**
 * Panel that contains the HorsUsage Workflow
 * @author Medes-IMPS
 */
public class HorsUsageFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, HorsUsageFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	HorsUsageEditorWorkflow editorWorkflow;
	 ...
	 */
	public HorsUsageFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new HorsUsageEditorWorkflow(requestFactory,
