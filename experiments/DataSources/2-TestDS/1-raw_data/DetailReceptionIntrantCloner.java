 ...
 * @author MEDES-IMPS
 */
public class DetailReceptionIntrantCloner {

	public static DetailReceptionIntrantBck cloneEntity(
			DetailReceptionIntrant entity) {
		DetailReceptionIntrantBck bck = new DetailReceptionIntrantBck();
