...
import org.imogene.epicam.client.ui.workflow.DetailCommandeMedicamentEditorWorkflow;
...
/**
 * Panel that contains the DetailCommandeMedicament Workflow
 * @author Medes-IMPS
 */
public class DetailCommandeMedicamentFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder
			extends
				UiBinder<Widget, DetailCommandeMedicamentFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	DetailCommandeMedicamentEditorWorkflow editorWorkflow;
	 ...
	 */
	public DetailCommandeMedicamentFormPanel(
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new DetailCommandeMedicamentEditorWorkflow(
