 ...
 * @author MEDES-IMPS
 */
public class ExamenSerologieEditorNestedRow extends Composite
		implements
			Editor<ExamenSerologieProxy>,
			HasEditorDelegate<ExamenSerologieProxy>,
			HasEditorErrors<ExamenSerologieProxy> {

	interface Binder extends UiBinder<Widget, ExamenSerologieEditorNestedRow> {
	}
	 ...
	 */
	public ExamenSerologieEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//dateTest.setLabel(NLS.constants().examenSerologie_field_dateTest(), HasHorizontalAlignment.ALIGN_RIGHT);
		dateTest.setLabelWidth("0px");
		//nature.setLabel(NLS.constants().examenSerologie_field_nature(), HasHorizontalAlignment.ALIGN_RIGHT);
		nature.setLabelWidth("0px");
		...
		//resultatCD4.setLabel(NLS.constants().examenSerologie_field_resultatCD4(), HasHorizontalAlignment.ALIGN_RIGHT);
		resultatCD4.setLabelWidth("0px");
		//resultatVIH.setLabel(NLS.constants().examenSerologie_field_resultatVIH(), HasHorizontalAlignment.ALIGN_RIGHT);
		resultatVIH.setLabelWidth("0px");
		resultatVIH.addItem(
