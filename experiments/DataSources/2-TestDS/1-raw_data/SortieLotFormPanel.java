...
import org.imogene.epicam.client.ui.workflow.SortieLotEditorWorkflow;
...
/**
 * Panel that contains the SortieLot Workflow
 * @author Medes-IMPS
 */
public class SortieLotFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, SortieLotFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	SortieLotEditorWorkflow editorWorkflow;
	 ...
	 */
	public SortieLotFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new SortieLotEditorWorkflow(requestFactory,
