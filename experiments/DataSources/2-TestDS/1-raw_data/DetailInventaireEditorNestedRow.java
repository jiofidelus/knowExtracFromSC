 ...
 * @author MEDES-IMPS
 */
public class DetailInventaireEditorNestedRow extends Composite
		implements
			Editor<DetailInventaireProxy>,
			HasEditorDelegate<DetailInventaireProxy>,
			HasEditorErrors<DetailInventaireProxy> {

	interface Binder extends UiBinder<Widget, DetailInventaireEditorNestedRow> {
	}
	 ...
	 */
	public DetailInventaireEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//CDT.setLabel(NLS.constants().detailInventaire_field_cDT(), HasHorizontalAlignment.ALIGN_RIGHT);
		...
		//lot.setLabel(NLS.constants().detailInventaire_field_lot(), HasHorizontalAlignment.ALIGN_RIGHT);
		lot.setLabelWidth("0px");
		//quantiteReelle.setLabel(NLS.constants().detailInventaire_field_quantiteReelle(), HasHorizontalAlignment.ALIGN_RIGHT);
		quantiteReelle.setLabelWidth("0px");
		//quantiteTheorique.setLabel(NLS.constants().detailInventaire_field_quantiteTheorique(), HasHorizontalAlignment.ALIGN_RIGHT);
		quantiteTheorique.setLabelWidth("0px");
				...
				new FieldValueChangeEvent.Handler() {
					...
					public void onValueChange(ImogField<?> field) {
						...
						if (field == lot) {
							...
							quantiteTheorique.setValue(value != null ? value
									.getQuantite() : null);
						}
					}
				}));
