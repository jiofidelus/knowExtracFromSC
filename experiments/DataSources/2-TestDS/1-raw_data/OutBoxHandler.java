...
/**
 * A data handler for the OutBox beans 
 * @author Medes-IMPS
 */
public class OutBoxHandler {
	...
	public OutBox findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public OutBox getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(OutBox entity, boolean isNew) {
	 ...
	 */
	@Transactional(readOnly = true)
	public List<OutBox> listOutBox(String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<OutBox> beans = dao.load(sortProperty, sortOrder, junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<OutBox> listOutBox(int i, int j, String sortProperty,
			boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<OutBox> beans = dao.load(i, j, sortProperty, sortOrder, junction);
	...
	/**
	 * Lists the non affected entities of type OutBox	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<OutBox> listNonAffectedOutBox(int i, int j,
		...
		List<OutBox> beans = dao.loadNonAffected(i, j, sortProperty, sortOrder,
				property, junction);
	...
	public List<OutBox> listNonAffectedOutBox(int i, int j,
		...
		return listNonAffectedOutBox(i, j, sortProperty, sortOrder, null,
				property);
	}

	/**
	 * Used when OutBox is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of OutBox non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<OutBox> listNonAffectedOutBoxReverse(int i, int j,
			String sortProperty, boolean sortOrder, ImogJunction criterions,
			String property) {
		...
		List<OutBox> beans = dao.loadNonAffectedReverse(i, j, sortProperty,
	...
	public List<OutBox> listNonAffectedOutBoxReverse(int i, int j,
			String sortProperty, boolean sortOrder, String property) {
		return listNonAffectedOutBoxReverse(i, j, sortProperty, sortOrder,
				null, property);
	}

	/**
	 * Gets an empty list of OutBox	
	 * @return an empty list of OutBox
	 */
	@Transactional(readOnly = true)
	public List<OutBox> getOutBoxEmptyList() {
		return new ArrayList<OutBox>();
	}

	/**
	 * Counts the number of outBox in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countOutBox() {
		return countOutBox(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countOutBox(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected outBox entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedOutBox(String property, ImogJunction criterions) {
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedOutBox(String property) {
		return countNonAffectedOutBox(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedOutBoxReverse(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedOutBoxReverse(String property) {
		return countNonAffectedOutBoxReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<OutBox> entities) {
		if (entities != null) {
	 ...
	 */
	@Transactional
	public void delete(OutBox entity) {
	...
	/**
	 * Lists the entities of type OutBox for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<OutBox> listForCsv(String sortProperty, boolean sortOrder,
			String message) {
		...
		if (message != null && !message.isEmpty()) {
			...
			criteria.setField("message");
			criteria.setValue(message);
			junction.add(criteria);
		}

		List<OutBox> beans = dao.load(sortProperty, sortOrder, junction);
		List<OutBox> securedBeans = filter.<OutBox> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the OutBox Dao
	 */
	public void setDao(OutBoxDao dao) {
		this.dao = dao;
	}
