...
/**
 * Filter panel to filter the EntreeLot entries
 * @author MEDES-IMPS
 */
public class EntreeLotFilterPanel extends ImogFilterPanel {
	...
	public void createFilterWidgets() {
		...
		quantiteFilterBox.setFilterLabel(NLS.constants()
	...
	public List<FilterCriteria> getFilterCriteria() {
		...
		quantiteCrit.setFieldDisplayName(NLS.constants()
				.entreeLot_field_quantite());
