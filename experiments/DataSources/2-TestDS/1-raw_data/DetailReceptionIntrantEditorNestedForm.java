 ...
 * @author MEDES-IMPS
 */
public class DetailReceptionIntrantEditorNestedForm extends Composite
		implements
	...
	interface Binder
			extends
				UiBinder<Widget, DetailReceptionIntrantEditorNestedForm> {
	}
	...
	@UiField
	@Ignore
	FieldGroupPanel detailReceptionIntrantSection;
	 ...
	 */
	public DetailReceptionIntrantEditorNestedForm(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		detailReceptionIntrantSection.setGroupTitle(NLS.constants()
				.detailReceptionIntrant_name());
		detailReceptionIntrantSection.setLabelFontSize("12px");
	...
	/**
	 */
	public void updatedetailReceptionIntrantSectionLabel(String label) {
		detailReceptionIntrantSection.setGroupTitle(label);
	}
