 ...
 * @author MEDES-IMPS
 */
public class ExamenBiologiqueEditorNestedRow extends Composite
		implements
			Editor<ExamenBiologiqueProxy>,
			HasEditorDelegate<ExamenBiologiqueProxy>,
			HasEditorErrors<ExamenBiologiqueProxy> {

	interface Binder extends UiBinder<Widget, ExamenBiologiqueEditorNestedRow> {
	}
	 ...
	 */
	public ExamenBiologiqueEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//date.setLabel(NLS.constants().examenBiologique_field_date(), HasHorizontalAlignment.ALIGN_RIGHT);
		date.setLabelWidth("0px");
		//poids.setLabel(NLS.constants().examenBiologique_field_poids(), HasHorizontalAlignment.ALIGN_RIGHT);
		poids.setLabelWidth("0px");
		//observations.setLabel(NLS.constants().examenBiologique_field_observations(), HasHorizontalAlignment.ALIGN_RIGHT);
		observations.setLabelWidth("0px");
