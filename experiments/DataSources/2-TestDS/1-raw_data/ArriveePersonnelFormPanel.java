...
import org.imogene.epicam.client.ui.workflow.ArriveePersonnelEditorWorkflow;
...
/**
 * Panel that contains the ArriveePersonnel Workflow
 * @author Medes-IMPS
 */
public class ArriveePersonnelFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, ArriveePersonnelFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	ArriveePersonnelEditorWorkflow editorWorkflow;
	 ...
	 */
	public ArriveePersonnelFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new ArriveePersonnelEditorWorkflow(
