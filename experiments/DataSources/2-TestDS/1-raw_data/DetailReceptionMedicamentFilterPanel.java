...
/**
 * Filter panel to filter the DetailReceptionMedicament entries
 * @author MEDES-IMPS
 */
public class DetailReceptionMedicamentFilterPanel extends ImogFilterPanel {
	...
	private TextBox detailcommande_medicament_designationBox;
	private ImogFilterBox detailcommande_medicament_designationFilterBox;
	...
	public DetailReceptionMedicamentFilterPanel() {
		super();
		setFieldReadAccess();
	}
	...
	public void resetFilterWidgets() {
		...
		detailcommande_medicament_designationBox.setValue(null);
	...
	public void createFilterWidgets() {
		...
		detailcommande_medicament_designationBox = new TextBox();
		detailcommande_medicament_designationFilterBox = new ImogFilterBox(
				detailcommande_medicament_designationBox);
		detailcommande_medicament_designationFilterBox.setFilterLabel(NLS
				.constants().medicament_field_designation());
		addTableFilter(detailcommande_medicament_designationFilterBox);
	...
	public List<FilterCriteria> getFilterCriteria() {
		...
		FilterCriteria detailcommande_medicament_designationCrit = new FilterCriteria();
		detailcommande_medicament_designationCrit
				.setField("detailCommande.medicament.designation");
		detailcommande_medicament_designationCrit.setFieldDisplayName(NLS
				.constants().medicament_field_designation());
		detailcommande_medicament_designationCrit
				.setOperation(CriteriaConstants.STRING_OPERATOR_CONTAINS);
		detailcommande_medicament_designationCrit
				.setValue(detailcommande_medicament_designationBox.getValue());
		detailcommande_medicament_designationCrit
				.setValueDisplayName(detailcommande_medicament_designationBox
						.getValue());
		criteria.add(detailcommande_medicament_designationCrit);
	...
	public void setFieldReadAccess() {
		...
		if (!AccessManager.canReadMedicamentDescription())
			detailcommande_medicament_designationFilterBox.setVisible(false);
