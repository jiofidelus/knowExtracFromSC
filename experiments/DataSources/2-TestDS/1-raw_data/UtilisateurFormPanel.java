...
import org.imogene.epicam.client.ui.workflow.UtilisateurEditorWorkflow;
...
/**
 * Panel that contains the Utilisateur Workflow
 * @author Medes-IMPS
 */
public class UtilisateurFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, UtilisateurFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	UtilisateurEditorWorkflow editorWorkflow;
	 ...
	 */
	public UtilisateurFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new UtilisateurEditorWorkflow(requestFactory,
