 ...
 * @author MEDES-IMPS
 */
public class SortieLotEditorNestedForm extends Composite
		implements
			Editor<SortieLotProxy>,
			HasEditorDelegate<SortieLotProxy>,
			HasEditorErrors<SortieLotProxy> {

	interface Binder extends UiBinder<Widget, SortieLotEditorNestedForm> {
	}
	 ...
	 */
	public SortieLotEditorNestedForm(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	/**
	 */
	public void updatesortieLotSectionLabel(String label) {
	}
