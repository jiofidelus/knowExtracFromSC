 ...
 * @author MEDES-IMPS
 */
public class CasTuberculosePriseMedicamenteusePhaseContinuationListEditor
		extends
			Composite
		implements
	...
	interface EditorUiBinder
			extends
				UiBinder<Widget, CasTuberculosePriseMedicamenteusePhaseContinuationListEditor> {
	}
	...
	public CasTuberculosePriseMedicamenteusePhaseContinuationListEditor(
		...
		listSection.setGroupTitle(NLS.constants()
				.casTuberculose_field_priseMedicamenteusePhaseContinuation());
	...
	private void add() {
		...
		//request.savePriseMedicamenteusePhaseContinuation(newPriseMedicamenteuse, true);
