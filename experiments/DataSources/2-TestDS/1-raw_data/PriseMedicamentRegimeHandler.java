...
/**
 * A data handler for the PriseMedicamentRegime beans 
 * @author Medes-IMPS
 */
public class PriseMedicamentRegimeHandler {
	...
	public PriseMedicamentRegime findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public PriseMedicamentRegime getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(PriseMedicamentRegime entity, boolean isNew) {
	...
	/**
	 * Lists the entities of type PriseMedicamentRegime
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of priseMedicamentRegime
	 */
	@Transactional(readOnly = true)
	public List<PriseMedicamentRegime> listPriseMedicamentRegime(
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<PriseMedicamentRegime> beans = dao.load(sortProperty, sortOrder,
				junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<PriseMedicamentRegime> listPriseMedicamentRegime(int i, int j,
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<PriseMedicamentRegime> beans = dao.load(i, j, sortProperty,
				sortOrder, junction);
	...
	/**
	 * Lists the non affected entities of type PriseMedicamentRegime	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<PriseMedicamentRegime> listNonAffectedPriseMedicamentRegime(
		...
		List<PriseMedicamentRegime> beans = dao.loadNonAffected(i, j,
	...
	public List<PriseMedicamentRegime> listNonAffectedPriseMedicamentRegime(
			int i, int j, String sortProperty, boolean sortOrder,
			String property) {
		return listNonAffectedPriseMedicamentRegime(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Used when PriseMedicamentRegime is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of PriseMedicamentRegime non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<PriseMedicamentRegime> listNonAffectedPriseMedicamentRegimeReverse(
			int i, int j, String sortProperty, boolean sortOrder,
			ImogJunction criterions, String property) {
		...
		List<PriseMedicamentRegime> beans = dao.loadNonAffectedReverse(i, j,
				sortProperty, sortOrder, property, junction);
	...
	public List<PriseMedicamentRegime> listNonAffectedPriseMedicamentRegimeReverse(
			int i, int j, String sortProperty, boolean sortOrder,
			String property) {
		return listNonAffectedPriseMedicamentRegimeReverse(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Gets an empty list of PriseMedicamentRegime	
	 * @return an empty list of PriseMedicamentRegime
	 */
	@Transactional(readOnly = true)
	public List<PriseMedicamentRegime> getPriseMedicamentRegimeEmptyList() {
		return new ArrayList<PriseMedicamentRegime>();
	}

	/**
	 * Counts the number of priseMedicamentRegime in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countPriseMedicamentRegime() {
		return countPriseMedicamentRegime(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countPriseMedicamentRegime(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected priseMedicamentRegime entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedPriseMedicamentRegime(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedPriseMedicamentRegime(String property) {
		return countNonAffectedPriseMedicamentRegime(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedPriseMedicamentRegimeReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedPriseMedicamentRegimeReverse(String property) {
		return countNonAffectedPriseMedicamentRegimeReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<PriseMedicamentRegime> entities) {
		if (entities != null) {
			for (PriseMedicamentRegime entity : entities)
				delete(entity);
		}
	}
	 ...
	 */
	@Transactional
	public void delete(PriseMedicamentRegime entity) {
	...
	/**
	 * Lists the entities of type PriseMedicamentRegime for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<PriseMedicamentRegime> listForCsv(String sortProperty,
			boolean sortOrder, String medicament_designation) {
		...
		List<PriseMedicamentRegime> beans = dao.load(sortProperty, sortOrder,
				junction);
		List<PriseMedicamentRegime> securedBeans = filter
				.<PriseMedicamentRegime> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the PriseMedicamentRegime Dao
	 */
	public void setDao(PriseMedicamentRegimeDao dao) {
		this.dao = dao;
	}
