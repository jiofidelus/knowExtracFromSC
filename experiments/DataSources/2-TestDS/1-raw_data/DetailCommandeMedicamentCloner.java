 ...
 * @author MEDES-IMPS
 */
public class DetailCommandeMedicamentCloner {

	public static DetailCommandeMedicamentBck cloneEntity(
			DetailCommandeMedicament entity) {
		DetailCommandeMedicamentBck bck = new DetailCommandeMedicamentBck();
		...
		bck.setQuantiteRequise(entity.getQuantiteRequise());

		bck.setQuantiteEnStock(entity.getQuantiteEnStock());
		return bck;
	}
}
