 ...
 * @author MEDES-IMPS
 */
public class DetailCommandeMedicamentEditorNestedRow extends Composite
		implements
	...
	interface Binder
			extends
				UiBinder<Widget, DetailCommandeMedicamentEditorNestedRow> {
	}
	 ...
	 */
	public DetailCommandeMedicamentEditorNestedRow(
	 ...
	 * @param factory the application request factory
	 */
	public DetailCommandeMedicamentEditorNestedRow(EpicamRequestFactory factory) {
		this(factory, false);
	}
	...
	public void properties() {
		...
		//medicament.setLabel(NLS.constants().detailCommandeMedicament_field_medicament(), HasHorizontalAlignment.ALIGN_RIGHT);
		medicament.setLabelWidth("0px");
		//quantiteRequise.setLabel(NLS.constants().detailCommandeMedicament_field_quantiteRequise(), HasHorizontalAlignment.ALIGN_RIGHT);
		quantiteRequise.setLabelWidth("0px");
		//quantiteEnStock.setLabel(NLS.constants().detailCommandeMedicament_field_quantiteEnStock(), HasHorizontalAlignment.ALIGN_RIGHT);
		quantiteEnStock.setLabelWidth("0px");
