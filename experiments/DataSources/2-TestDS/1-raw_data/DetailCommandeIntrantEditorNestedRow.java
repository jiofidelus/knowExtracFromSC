 ...
 * @author MEDES-IMPS
 */
public class DetailCommandeIntrantEditorNestedRow extends Composite
		implements
	...
	interface Binder
			extends
				UiBinder<Widget, DetailCommandeIntrantEditorNestedRow> {
	}
	 ...
	 */
	public DetailCommandeIntrantEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//intrant.setLabel(NLS.constants().detailCommandeIntrant_field_intrant(), HasHorizontalAlignment.ALIGN_RIGHT);
		intrant.setLabelWidth("0px");
		//quantiteRequise.setLabel(NLS.constants().detailCommandeIntrant_field_quantiteRequise(), HasHorizontalAlignment.ALIGN_RIGHT);
		quantiteRequise.setLabelWidth("0px");
		//quantiteEnStock.setLabel(NLS.constants().detailCommandeIntrant_field_quantiteEnStock(), HasHorizontalAlignment.ALIGN_RIGHT);
