...
import org.imogene.epicam.client.ui.workflow.DetailRavitaillementEditorWorkflow;
...
/**
 * Panel that contains the DetailRavitaillement Workflow
 * @author Medes-IMPS
 */
public class DetailRavitaillementFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, DetailRavitaillementFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	DetailRavitaillementEditorWorkflow editorWorkflow;
	 ...
	 */
	public DetailRavitaillementFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new DetailRavitaillementEditorWorkflow(
	...
	/**
	 * Setter to inject a Ravitaillement value into the workflow and the editor
	 * @param value the value to be injected
	 * @param isLocked true if relation field shall be locked (non editable)
	 */
	public void setRavitaillement(RavitaillementProxy value, boolean isLocked) {
		editorWorkflow.setRavitaillement(value, isLocked);
	}
