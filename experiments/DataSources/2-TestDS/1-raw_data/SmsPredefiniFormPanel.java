...
import org.imogene.epicam.client.ui.workflow.SmsPredefiniEditorWorkflow;
...
/**
 * Panel that contains the SmsPredefini Workflow
 * @author Medes-IMPS
 */
public class SmsPredefiniFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, SmsPredefiniFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	SmsPredefiniEditorWorkflow editorWorkflow;
	 ...
	 */
	public SmsPredefiniFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new SmsPredefiniEditorWorkflow(requestFactory,
