 ...
 * @author MEDES-IMPS
 */
public class RendezVousCloner {

	public static RendezVousBck cloneEntity(RendezVous entity) {
		RendezVousBck bck = new RendezVousBck();
		...
		bck.setDateRendezVous(entity.getDateRendezVous());

		bck.setHonore(entity.getHonore());

		bck.setNombreSMSEnvoye(entity.getNombreSMSEnvoye());

		bck.setCommentaire(entity.getCommentaire());
		return bck;
	}
}
