...
import org.imogene.epicam.client.ui.workflow.PersonnelEditorWorkflow;
...
/**
 * Panel that contains the Personnel Workflow
 * @author Medes-IMPS
 */
public class PersonnelFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, PersonnelFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	PersonnelEditorWorkflow editorWorkflow;
	 ...
	 */
	public PersonnelFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new PersonnelEditorWorkflow(requestFactory,
