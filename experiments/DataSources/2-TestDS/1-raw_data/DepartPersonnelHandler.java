...
/**
 * A data handler for the DepartPersonnel beans 
 * @author Medes-IMPS
 */
public class DepartPersonnelHandler {
	...
	public DepartPersonnel findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public DepartPersonnel getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(DepartPersonnel entity, boolean isNew) {
	...
	/**
	 * Lists the entities of type DepartPersonnel
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of departPersonnel
	 */
	@Transactional(readOnly = true)
	public List<DepartPersonnel> listDepartPersonnel(String sortProperty,
			boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<DepartPersonnel> beans = dao.load(sortProperty, sortOrder,
				junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DepartPersonnel> listDepartPersonnel(int i, int j,
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<DepartPersonnel> beans = dao.load(i, j, sortProperty, sortOrder,
				junction);
	...
	/**
	 * Lists the non affected entities of type DepartPersonnel	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DepartPersonnel> listNonAffectedDepartPersonnel(int i, int j,
			String sortProperty, boolean sortOrder, ImogJunction criterions,
			String property) {
		...
		List<DepartPersonnel> beans = dao.loadNonAffected(i, j, sortProperty,
	...
	public List<DepartPersonnel> listNonAffectedDepartPersonnel(int i, int j,
		...
		return listNonAffectedDepartPersonnel(i, j, sortProperty, sortOrder,
				null, property);
	}

	/**
	 * Used when DepartPersonnel is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of DepartPersonnel non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<DepartPersonnel> listNonAffectedDepartPersonnelReverse(int i,
		...
		List<DepartPersonnel> beans = dao.loadNonAffectedReverse(i, j,
	...
	public List<DepartPersonnel> listNonAffectedDepartPersonnelReverse(int i,
		...
		return listNonAffectedDepartPersonnelReverse(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Gets an empty list of DepartPersonnel	
	 * @return an empty list of DepartPersonnel
	 */
	@Transactional(readOnly = true)
	public List<DepartPersonnel> getDepartPersonnelEmptyList() {
		return new ArrayList<DepartPersonnel>();
	}

	/**
	 * Counts the number of departPersonnel in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countDepartPersonnel() {
		return countDepartPersonnel(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countDepartPersonnel(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected departPersonnel entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedDepartPersonnel(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedDepartPersonnel(String property) {
		return countNonAffectedDepartPersonnel(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedDepartPersonnelReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedDepartPersonnelReverse(String property) {
		return countNonAffectedDepartPersonnelReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<DepartPersonnel> entities) {
		if (entities != null) {
			for (DepartPersonnel entity : entities)
				delete(entity);
		}
	}
	 ...
	 */
	@Transactional
	public void delete(DepartPersonnel entity) {
	...
	/**
	 * Lists the entities of type DepartPersonnel for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<DepartPersonnel> listForCsv(String sortProperty,
			boolean sortOrder, String dateDepartBefore, String dateDepartAfter,
			String region_nom_francais, String region_nom_english,
			String districtSante_nom_francais,
		...
		List<DepartPersonnel> beans = dao.load(sortProperty, sortOrder,
				junction);
		List<DepartPersonnel> securedBeans = filter
				.<DepartPersonnel> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the DepartPersonnel Dao
	 */
	public void setDao(DepartPersonnelDao dao) {
		this.dao = dao;
	}
