...
import org.imogene.epicam.client.ui.workflow.CommandeEditorWorkflow;
...
/**
 * Panel that contains the Commande Workflow
 * @author Medes-IMPS
 */
public class CommandeFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, CommandeFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	CommandeEditorWorkflow editorWorkflow;
	 ...
	 */
	public CommandeFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new CommandeEditorWorkflow(requestFactory,
