...
import org.imogene.epicam.client.ui.workflow.MedicamentEditorWorkflow;
...
/**
 * Panel that contains the Medicament Workflow
 * @author Medes-IMPS
 */
public class MedicamentFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, MedicamentFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	MedicamentEditorWorkflow editorWorkflow;
	 ...
	 */
	public MedicamentFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new MedicamentEditorWorkflow(requestFactory,
