...
import org.imogene.epicam.client.ui.workflow.CandidatureFormationEditorWorkflow;
...
/**
 * Panel that contains the CandidatureFormation Workflow
 * @author Medes-IMPS
 */
public class CandidatureFormationFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, CandidatureFormationFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	CandidatureFormationEditorWorkflow editorWorkflow;
	 ...
	 */
	public CandidatureFormationFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new CandidatureFormationEditorWorkflow(
	...
	/**
	 * Setter to inject a Formation value into the workflow and the editor
	 * @param value the value to be injected
	 * @param isLocked true if relation field shall be locked (non editable)
	 */
	public void setFormation(FormationProxy value, boolean isLocked) {
		editorWorkflow.setFormation(value, isLocked);
	}
	...
	/**
	 * Setter to inject a Personnel value into the workflow and the editor
	 * @param value the value to be injected
	 * @param isLocked true if relation field shall be locked (non editable)
	 */
	public void setPersonnel(PersonnelProxy value, boolean isLocked) {
		editorWorkflow.setPersonnel(value, isLocked);
	}
