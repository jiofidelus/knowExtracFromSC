...
import org.imogene.epicam.client.ui.workflow.DetailCommandeIntrantEditorWorkflow;
...
/**
 * Panel that contains the DetailCommandeIntrant Workflow
 * @author Medes-IMPS
 */
public class DetailCommandeIntrantFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, DetailCommandeIntrantFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	DetailCommandeIntrantEditorWorkflow editorWorkflow;
	 ...
	 */
	public DetailCommandeIntrantFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new DetailCommandeIntrantEditorWorkflow(
	...
	/**
	 * Setter to inject a Intrant value into the workflow and the editor
	 * @param value the value to be injected
	 * @param isLocked true if relation field shall be locked (non editable)
	 */
	public void setIntrant(IntrantProxy value, boolean isLocked) {
		editorWorkflow.setIntrant(value, isLocked);
	}
