 ...
 * @author MEDES-IMPS
 */
public class PriseMedicamenteuseCloner {

	public static PriseMedicamenteuseBck cloneEntity(PriseMedicamenteuse entity) {
		PriseMedicamenteuseBck bck = new PriseMedicamenteuseBck();
		...
		if (entity.getPhaseIntensive() != null) {
			bck.setPhaseIntensive(entity.getPhaseIntensive().getId());
		}

		if (entity.getPhaseContinuation() != null) {
			bck.setPhaseContinuation(entity.getPhaseContinuation().getId());
		}

		bck.setDateEffective(entity.getDateEffective());

		bck.setPrise(entity.getPrise());
