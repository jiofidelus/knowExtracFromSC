 ...
 * @author MEDES-IMPS
 */
public class DetailReceptionMedicamentEditor extends Composite
		implements
	...
	interface Binder extends UiBinder<Widget, DetailReceptionMedicamentEditor> {
	}
	...
	private DetailReceptionMedicamentProxy editedValue; //Not used by the editor
	 ...
	 */
	public DetailReceptionMedicamentEditor(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	private void properties() {
		...
		reception.setLabel(NLS.constants()
				.detailReceptionMedicament_field_reception());
		// hidden field
	...
	public void setRequestContextForListEditors(
			DetailReceptionMedicamentRequest ctx) {
	...
	/**
	 * Gets the DetailReceptionMedicamentProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities
	 * @return
	 */
	public DetailReceptionMedicamentProxy getEditedValue() {
		return editedValue;
	}

	/**
	 * Sets the DetailReceptionMedicamentProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities	 
	 * @param editedValue 
	 */
	public void setEditedValue(DetailReceptionMedicamentProxy editedValue) {
