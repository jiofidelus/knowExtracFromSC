...
/**
 * A data handler for the CasIndex beans 
 * @author Medes-IMPS
 */
public class CasIndexHandler {
	...
	public CasIndex findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public CasIndex getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(CasIndex entity, boolean isNew) {
	...
	/**
	 * Lists the entities of type CasIndex
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of casIndex
	 */
	@Transactional(readOnly = true)
	public List<CasIndex> listCasIndex(String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<CasIndex> beans = dao.load(sortProperty, sortOrder, junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<CasIndex> listCasIndex(int i, int j, String sortProperty,
			boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<CasIndex> beans = dao
	...
	/**
	 * Lists the non affected entities of type CasIndex	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<CasIndex> listNonAffectedCasIndex(int i, int j,
		...
		List<CasIndex> beans = dao.loadNonAffected(i, j, sortProperty,
	...
	public List<CasIndex> listNonAffectedCasIndex(int i, int j,
		...
		return listNonAffectedCasIndex(i, j, sortProperty, sortOrder, null,
				property);
	}

	/**
	 * Used when CasIndex is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of CasIndex non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<CasIndex> listNonAffectedCasIndexReverse(int i, int j,
			String sortProperty, boolean sortOrder, ImogJunction criterions,
			String property) {
		...
		List<CasIndex> beans = dao.loadNonAffectedReverse(i, j, sortProperty,
				sortOrder, property, junction);
	...
	public List<CasIndex> listNonAffectedCasIndexReverse(int i, int j,
			String sortProperty, boolean sortOrder, String property) {
		return listNonAffectedCasIndexReverse(i, j, sortProperty, sortOrder,
				null, property);
	}

	/**
	 * Gets an empty list of CasIndex	
	 * @return an empty list of CasIndex
	 */
	@Transactional(readOnly = true)
	public List<CasIndex> getCasIndexEmptyList() {
		return new ArrayList<CasIndex>();
	}

	/**
	 * Counts the number of casIndex in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countCasIndex() {
		return countCasIndex(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countCasIndex(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected casIndex entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedCasIndex(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedCasIndex(String property) {
		return countNonAffectedCasIndex(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedCasIndexReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedCasIndexReverse(String property) {
		return countNonAffectedCasIndexReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<CasIndex> entities) {
		if (entities != null) {
			for (CasIndex entity : entities)
				delete(entity);
		}
	}
	 ...
	 */
	@Transactional
	public void delete(CasIndex entity) {
	...
	/**
	 * Lists the entities of type CasIndex for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<CasIndex> listForCsv(String sortProperty, boolean sortOrder,
			String patient_identifiant, String patient_nom,
			String typeRelation, String patientLie_identifiant,
			String patientLie_nom) {
		...
		if (typeRelation != null && !typeRelation.isEmpty()) {
			BasicCriteria criteria = new BasicCriteria();
			criteria.setOperation(CriteriaConstants.STRING_OPERATOR_CONTAINS);
			criteria.setField("typeRelation");
			criteria.setValue(typeRelation);
			junction.add(criteria);
		}
		if (patientLie_identifiant != null && !patientLie_identifiant.isEmpty()) {
			BasicCriteria criteria = new BasicCriteria();
			criteria.setOperation(CriteriaConstants.STRING_OPERATOR_CONTAINS);
			criteria.setField("patientLie.identifiant");
			criteria.setValue(patientLie_identifiant);
			junction.add(criteria);
		}
		if (patientLie_nom != null && !patientLie_nom.isEmpty()) {
			BasicCriteria criteria = new BasicCriteria();
			criteria.setOperation(CriteriaConstants.STRING_OPERATOR_CONTAINS);
			criteria.setField("patientLie.nom");
			criteria.setValue(patientLie_nom);
			junction.add(criteria);
		}

		List<CasIndex> beans = dao.load(sortProperty, sortOrder, junction);
		List<CasIndex> securedBeans = filter.<CasIndex> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the CasIndex Dao
	 */
	public void setDao(CasIndexDao dao) {
		this.dao = dao;
	}
