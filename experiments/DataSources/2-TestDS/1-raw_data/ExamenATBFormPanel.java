...
import org.imogene.epicam.client.ui.workflow.ExamenATBEditorWorkflow;
...
/**
 * Panel that contains the ExamenATB Workflow
 * @author Medes-IMPS
 */
public class ExamenATBFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, ExamenATBFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	ExamenATBEditorWorkflow editorWorkflow;
	 ...
	 */
	public ExamenATBFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new ExamenATBEditorWorkflow(requestFactory,
