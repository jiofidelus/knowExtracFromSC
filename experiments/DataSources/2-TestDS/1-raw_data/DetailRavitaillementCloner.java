 ...
 * @author MEDES-IMPS
 */
public class DetailRavitaillementCloner {

	public static DetailRavitaillementBck cloneEntity(
			DetailRavitaillement entity) {
		DetailRavitaillementBck bck = new DetailRavitaillementBck();
		...
		if (entity.getRavitaillement() != null) {
			bck.setRavitaillement(entity.getRavitaillement().getId());
		}

		if (entity.getSortieLot() != null) {
			bck.setSortieLot(entity.getSortieLot().getId());
		}
