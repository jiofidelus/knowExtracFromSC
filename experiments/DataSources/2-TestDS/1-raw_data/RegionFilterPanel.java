...
/**
 * Filter panel to filter the Region entries
 * @author MEDES-IMPS
 */
public class RegionFilterPanel extends ImogFilterPanel {
	...
	public void createFilterWidgets() {
		...
		codeFilterBox.setFilterLabel(NLS.constants().region_field_code());
		addTableFilter(codeFilterBox);

		nomBox = new TextBox();
		nomFilterBox = new ImogFilterBox(nomBox);
		nomFilterBox.setFilterLabel(NLS.constants().region_field_nom());
	...
	public List<FilterCriteria> getFilterCriteria() {
		...
		codeCrit.setFieldDisplayName(NLS.constants().region_field_code());
		...
		nomCrit.setFieldDisplayName(NLS.constants().region_field_nom());
