...
import org.imogene.epicam.client.ui.workflow.LieuDitEditorWorkflow;
...
/**
 * Panel that contains the LieuDit Workflow
 * @author Medes-IMPS
 */
public class LieuDitFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, LieuDitFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	LieuDitEditorWorkflow editorWorkflow;
	 ...
	 */
	public LieuDitFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new LieuDitEditorWorkflow(requestFactory,
	 ...
	 * @param entityId the id of the entity to be managed by the workflow. null if an entity is being created	 
	 */
	public LieuDitFormPanel(EpicamRequestFactory requestFactory, String entityId) {
