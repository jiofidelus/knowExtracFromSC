 ...
 * @author MEDES-IMPS
 */
public class InventaireCloner {

	public static InventaireBck cloneEntity(Inventaire entity) {
		InventaireBck bck = new InventaireBck();
		...
		if (entity.getDetails() != null) {
			...
			for (DetailInventaire i : entity.getDetails()) {
