...
import org.imogene.epicam.client.ui.workflow.IntrantEditorWorkflow;
...
/**
 * Panel that contains the Intrant Workflow
 * @author Medes-IMPS
 */
public class IntrantFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, IntrantFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	IntrantEditorWorkflow editorWorkflow;
	 ...
	 */
	public IntrantFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new IntrantEditorWorkflow(requestFactory,
	 ...
	 * @param entityId the id of the entity to be managed by the workflow. null if an entity is being created	 
	 */
	public IntrantFormPanel(EpicamRequestFactory requestFactory, String entityId) {
