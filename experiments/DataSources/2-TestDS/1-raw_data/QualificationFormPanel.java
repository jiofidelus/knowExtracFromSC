...
import org.imogene.epicam.client.ui.workflow.QualificationEditorWorkflow;
...
/**
 * Panel that contains the Qualification Workflow
 * @author Medes-IMPS
 */
public class QualificationFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, QualificationFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	QualificationEditorWorkflow editorWorkflow;
	 ...
	 */
	public QualificationFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new QualificationEditorWorkflow(
