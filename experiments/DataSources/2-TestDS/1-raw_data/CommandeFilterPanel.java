...
/**
 * Filter panel to filter the Commande entries
 * @author MEDES-IMPS
 */
public class CommandeFilterPanel extends ImogFilterPanel {
	...
	public void createFilterWidgets() {
		...
		dateAfterFilterBox.setFilterLabel(NLS.constants().commande_field_date()
