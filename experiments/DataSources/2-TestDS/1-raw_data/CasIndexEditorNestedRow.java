 ...
 * @author MEDES-IMPS
 */
public class CasIndexEditorNestedRow extends Composite
		implements
			Editor<CasIndexProxy>,
			HasEditorDelegate<CasIndexProxy>,
			HasEditorErrors<CasIndexProxy> {

	interface Binder extends UiBinder<Widget, CasIndexEditorNestedRow> {
	}
	 ...
	 */
	public CasIndexEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//patientLie.setLabel(NLS.constants().casIndex_field_patientLie(), HasHorizontalAlignment.ALIGN_RIGHT);
		patientLie.setLabelWidth("0px");
		//typeRelation.setLabel(NLS.constants().casIndex_field_typeRelation(), HasHorizontalAlignment.ALIGN_RIGHT);
		typeRelation.setLabelWidth("0px");
