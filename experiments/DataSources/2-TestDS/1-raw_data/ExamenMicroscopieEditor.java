...
/**
 * Editor that provides the UI components that allow a ExamenMicroscopieProxy to be viewed and edited
 * @author MEDES-IMPS
 */
public class ExamenMicroscopieEditor extends Composite
		implements
			Editor<ExamenMicroscopieProxy>,
			HasEditorDelegate<ExamenMicroscopieProxy>,
			HasEditorErrors<ExamenMicroscopieProxy> {

	interface Binder extends UiBinder<Widget, ExamenMicroscopieEditor> {
	}
	...
	private EditorDelegate<ExamenMicroscopieProxy> delegate;

	private ExamenMicroscopieProxy editedValue; //Not used by the editor
	 ...
	 */
	public ExamenMicroscopieEditor(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	private void properties() {
		...
		resultat.addItem(
				EpicamEnumConstants.EXAMENMICROSCOPIE_RESULTAT_NEGATIF, NLS
						.constants()
						.examenMicroscopie_resultat_negatif_option());
		resultat.addItem(EpicamEnumConstants.EXAMENMICROSCOPIE_RESULTAT_RARE,
				NLS.constants().examenMicroscopie_resultat_rare_option());
		resultat.addItem(EpicamEnumConstants.EXAMENMICROSCOPIE_RESULTAT_UNPLUS,
				NLS.constants().examenMicroscopie_resultat_unPlus_option());
		resultat.addItem(
				EpicamEnumConstants.EXAMENMICROSCOPIE_RESULTAT_DEUXPLUS, NLS
						.constants()
						.examenMicroscopie_resultat_deuxPlus_option());
		resultat.addItem(
				EpicamEnumConstants.EXAMENMICROSCOPIE_RESULTAT_TROISPLUS, NLS
						.constants()
						.examenMicroscopie_resultat_troisPlus_option());
		observations.setLabel(NLS.constants()
				.examenMicroscopie_field_observations());
	...
	private void setFieldReadAccess() {
		...
		if (!AccessManager.canReadExamenMicroscopieCentreExamen())
	...
	private void setFieldEditAccess() {
		...
		/* Examen section widgets visibility */
		if (!AccessManager.canEditExamenMicroscopieExamen())
			examenSection.setVisible(false);
	 ...
	 */
	public void setRequestContextForListEditors(ExamenMicroscopieRequest ctx) {
	}
	...
	/**
	 * Gets the ExamenMicroscopieProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities
	 * @return
	 */
	public ExamenMicroscopieProxy getEditedValue() {
		return editedValue;
	}

	/**
	 * Sets the ExamenMicroscopieProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities	 
	 * @param editedValue 
	 */
	public void setEditedValue(ExamenMicroscopieProxy editedValue) {
	...
	@Override
	public void setDelegate(EditorDelegate<ExamenMicroscopieProxy> delegate) {
