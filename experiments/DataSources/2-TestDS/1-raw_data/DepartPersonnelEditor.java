...
/**
 * Editor that provides the UI components that allow a DepartPersonnelProxy to be viewed and edited
 * @author MEDES-IMPS
 */
public class DepartPersonnelEditor extends Composite
		implements
			Editor<DepartPersonnelProxy>,
			HasEditorDelegate<DepartPersonnelProxy>,
			HasEditorErrors<DepartPersonnelProxy> {

	interface Binder extends UiBinder<Widget, DepartPersonnelEditor> {
	}
	...
	private EditorDelegate<DepartPersonnelProxy> delegate;

	private DepartPersonnelProxy editedValue; //Not used by the editor
	private boolean hideButtons = false;

	/* Personnel section widgets */
	@UiField
	@Ignore
	FieldGroupPanel personnelSection;
	 ...
	 */
	public DepartPersonnelEditor(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	private void properties() {
		...
		/* Personnel section widgets */
		personnelSection.setGroupTitle(NLS.constants()
				.departPersonnel_group_personnel());
		region.setLabel(NLS.constants().departPersonnel_field_region());
	...
	private void setFieldReadAccess() {
		...
		/* Personnel section widgets visibility */
		if (!AccessManager.canReadDepartPersonnelPersonnel())
			personnelSection.setVisible(false);
	...
	private void setFieldEditAccess() {
		...
		/* Personnel section widgets visibility */
		if (!AccessManager.canEditDepartPersonnelPersonnel())
			personnelSection.setVisible(false);

		/* Description section widgets visibility */
		if (!AccessManager.canEditDepartPersonnelDescription())
			descriptionSection.setVisible(false);
	 ...
	 */
	public void setRequestContextForListEditors(DepartPersonnelRequest ctx) {
	}
	...
	/**
	 * Gets the DepartPersonnelProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities
	 * @return
	 */
	public DepartPersonnelProxy getEditedValue() {
		return editedValue;
	}

	/**
	 * Sets the DepartPersonnelProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities	 
	 * @param editedValue 
	 */
	public void setEditedValue(DepartPersonnelProxy editedValue) {
	...
	@Override
	public void setDelegate(EditorDelegate<DepartPersonnelProxy> delegate) {
