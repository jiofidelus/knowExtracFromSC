...
import org.imogene.epicam.client.ui.workflow.CentreDiagTraitEditorWorkflow;
...
/**
 * Panel that contains the CentreDiagTrait Workflow
 * @author Medes-IMPS
 */
public class CentreDiagTraitFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, CentreDiagTraitFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	CentreDiagTraitEditorWorkflow editorWorkflow;
	 ...
	 */
	public CentreDiagTraitFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new CentreDiagTraitEditorWorkflow(
