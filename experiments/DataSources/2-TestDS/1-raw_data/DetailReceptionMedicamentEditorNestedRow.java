 ...
 * @author MEDES-IMPS
 */
public class DetailReceptionMedicamentEditorNestedRow extends Composite
		implements
	...
	interface Binder
			extends
				UiBinder<Widget, DetailReceptionMedicamentEditorNestedRow> {
	}
	 ...
	 */
	public DetailReceptionMedicamentEditorNestedRow(
	 ...
	 * @param factory the application request factory
	 */
	public DetailReceptionMedicamentEditorNestedRow(EpicamRequestFactory factory) {
		this(factory, false);
	}
	...
	public void properties() {
		...
		//commande.setLabel(NLS.constants().detailReceptionMedicament_field_commande(), HasHorizontalAlignment.ALIGN_RIGHT);
		...
		//detailCommande.setLabel(NLS.constants().detailReceptionMedicament_field_detailCommande(), HasHorizontalAlignment.ALIGN_RIGHT);
		detailCommande.setLabelWidth("0px");
		//entreeLot.setLabel(NLS.constants().detailReceptionMedicament_field_entreeLot(), HasHorizontalAlignment.ALIGN_RIGHT);
