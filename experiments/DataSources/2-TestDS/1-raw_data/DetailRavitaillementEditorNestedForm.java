 ...
 * @author MEDES-IMPS
 */
public class DetailRavitaillementEditorNestedForm extends Composite
		implements
	 ...
	 */
	public DetailRavitaillementEditorNestedForm(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		detailRavitaillementSection.setGroupTitle(NLS.constants()
				.detailRavitaillement_name());
		detailRavitaillementSection.setLabelFontSize("12px");
	...
	/**
	 */
	public void updatedetailRavitaillementSectionLabel(String label) {
		detailRavitaillementSection.setGroupTitle(label);
	}
