 ...
 * @author MEDES-IMPS
 */
public class ExamenBiologiqueCloner {

	public static ExamenBiologiqueBck cloneEntity(ExamenBiologique entity) {
		ExamenBiologiqueBck bck = new ExamenBiologiqueBck();
