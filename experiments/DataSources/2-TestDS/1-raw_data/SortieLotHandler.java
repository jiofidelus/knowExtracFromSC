...
/**
 * A data handler for the SortieLot beans 
 * @author Medes-IMPS
 */
public class SortieLotHandler {
	...
	public SortieLot findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public SortieLot getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(SortieLot entity, boolean isNew) {
	...
	/**
	 * Lists the entities of type SortieLot
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of sortieLot
	 */
	@Transactional(readOnly = true)
	public List<SortieLot> listSortieLot(String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<SortieLot> beans = dao.load(sortProperty, sortOrder, junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<SortieLot> listSortieLot(String sortProperty,
	 ...
	 */
	@Transactional(readOnly = true)
	public List<SortieLot> listSortieLot(int i, int j, String sortProperty,
			boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<SortieLot> beans = dao.load(i, j, sortProperty, sortOrder,
				junction);
	...
	/**
	 * Lists the non affected entities of type SortieLot	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<SortieLot> listNonAffectedSortieLot(int i, int j,
		...
		List<SortieLot> beans = dao.loadNonAffected(i, j, sortProperty,
	...
	public List<SortieLot> listNonAffectedSortieLot(int i, int j,
		...
		return listNonAffectedSortieLot(i, j, sortProperty, sortOrder, null,
				property);
	}

	/**
	 * Used when SortieLot is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of SortieLot non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<SortieLot> listNonAffectedSortieLotReverse(int i, int j,
			String sortProperty, boolean sortOrder, ImogJunction criterions,
			String property) {
		...
		List<SortieLot> beans = dao.loadNonAffectedReverse(i, j, sortProperty,
				sortOrder, property, junction);
	...
	public List<SortieLot> listNonAffectedSortieLotReverse(int i, int j,
			String sortProperty, boolean sortOrder, String property) {
		return listNonAffectedSortieLotReverse(i, j, sortProperty, sortOrder,
				null, property);
	}

	/**
	 * Gets an empty list of SortieLot	
	 * @return an empty list of SortieLot
	 */
	@Transactional(readOnly = true)
	public List<SortieLot> getSortieLotEmptyList() {
		return new ArrayList<SortieLot>();
	}

	/**
	 * Counts the number of sortieLot in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countSortieLot() {
		return countSortieLot(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countSortieLot(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected sortieLot entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedSortieLot(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedSortieLot(String property) {
		return countNonAffectedSortieLot(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedSortieLotReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedSortieLotReverse(String property) {
		return countNonAffectedSortieLotReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<SortieLot> entities) {
		if (entities != null) {
			for (SortieLot entity : entities)
				delete(entity);
		}
	}
	 ...
	 */
	@Transactional
	public void delete(SortieLot entity) {
	...
	/**
	 * Lists the entities of type SortieLot for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<SortieLot> listForCsv(String sortProperty, boolean sortOrder,
		...
		List<SortieLot> beans = dao.load(sortProperty, sortOrder, junction);
		List<SortieLot> securedBeans = filter.<SortieLot> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the SortieLot Dao
	 */
	public void setDao(SortieLotDao dao) {
		this.dao = dao;
	}
