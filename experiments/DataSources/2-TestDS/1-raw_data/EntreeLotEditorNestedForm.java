 ...
 * @author MEDES-IMPS
 */
public class EntreeLotEditorNestedForm extends Composite
		implements
			Editor<EntreeLotProxy>,
			HasEditorDelegate<EntreeLotProxy>,
			HasEditorErrors<EntreeLotProxy> {

	interface Binder extends UiBinder<Widget, EntreeLotEditorNestedForm> {
	}
	...
	@UiField
	@Ignore
	FieldGroupPanel entreeLotSection;
	 ...
	 */
	public EntreeLotEditorNestedForm(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		entreeLotSection.setGroupTitle(NLS.constants().entreeLot_name());
		entreeLotSection.setLabelFontSize("12px");
	...
	/**
	 */
	public void updateentreeLotSectionLabel(String label) {
		entreeLotSection.setGroupTitle(label);
	}
