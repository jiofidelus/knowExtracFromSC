...
import org.imogene.epicam.client.ui.workflow.ReceptionEditorWorkflow;
...
/**
 * Panel that contains the Reception Workflow
 * @author Medes-IMPS
 */
public class ReceptionFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, ReceptionFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	ReceptionEditorWorkflow editorWorkflow;
	 ...
	 */
	public ReceptionFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new ReceptionEditorWorkflow(requestFactory,
