 ...
 * @author MEDES-IMPS
 */
public class DetailInventaireCloner {

	public static DetailInventaireBck cloneEntity(DetailInventaire entity) {
		DetailInventaireBck bck = new DetailInventaireBck();
		...
		if (entity.getInventaire() != null) {
			bck.setInventaire(entity.getInventaire().getId());
		}
		...
		if (entity.getLot() != null) {
			bck.setLot(entity.getLot().getId());
		}

		bck.setQuantiteReelle(entity.getQuantiteReelle());

		bck.setQuantiteTheorique(entity.getQuantiteTheorique());
		return bck;
	}
}
