 ...
 * @author MEDES-IMPS
 */
public class ArriveePersonnelCloner {

	public static ArriveePersonnelBck cloneEntity(ArriveePersonnel entity) {
		ArriveePersonnelBck bck = new ArriveePersonnelBck();
