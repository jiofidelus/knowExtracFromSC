 ...
 * @author MEDES-IMPS
 */
public class CandidatureFormationEditorNestedRow extends Composite
		implements
	...
	interface Binder
			extends
				UiBinder<Widget, CandidatureFormationEditorNestedRow> {
	}
	 ...
	 */
	public CandidatureFormationEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//region.setLabel(NLS.constants().candidatureFormation_field_region(), HasHorizontalAlignment.ALIGN_RIGHT);
		region.setLabelWidth("0px");
		// the value of region affects the value of other fields
		region.notifyChanges(requestFactory.getEventBus());
		//districtSante.setLabel(NLS.constants().candidatureFormation_field_districtSante(), HasHorizontalAlignment.ALIGN_RIGHT);
		districtSante.setLabelWidth("0px");
		// the value of districtSante affects the value of other fields
		districtSante.notifyChanges(requestFactory.getEventBus());
		//CDT.setLabel(NLS.constants().candidatureFormation_field_cDT(), HasHorizontalAlignment.ALIGN_RIGHT);
		CDT.setLabelWidth("0px");
		// the value of CDT affects the value of other fields
		CDT.notifyChanges(requestFactory.getEventBus());
		//personnel.setLabel(NLS.constants().candidatureFormation_field_personnel(), HasHorizontalAlignment.ALIGN_RIGHT);
		personnel.setLabelWidth("0px");
		//approuveeRegion.setLabel(NLS.constants().candidatureFormation_field_approuveeRegion(), HasHorizontalAlignment.ALIGN_RIGHT);
		approuveeRegion.setLabelWidth("0px");
		...
		//motifRejetRegion.setLabel(NLS.constants().candidatureFormation_field_motifRejetRegion(), HasHorizontalAlignment.ALIGN_RIGHT);
		motifRejetRegion.setLabelWidth("0px");
		//approuveeGTC.setLabel(NLS.constants().candidatureFormation_field_approuveeGTC(), HasHorizontalAlignment.ALIGN_RIGHT);
		approuveeGTC.setLabelWidth("0px");
		// the value of approuveeGTC affects the visibility of other fields
		approuveeGTC.notifyChanges(requestFactory.getEventBus());
		//motifRejetGTC.setLabel(NLS.constants().candidatureFormation_field_motifRejetGTC(), HasHorizontalAlignment.ALIGN_RIGHT);
		motifRejetGTC.setLabelWidth("0px");
