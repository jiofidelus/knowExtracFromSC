...
import org.imogene.epicam.client.ui.workflow.LotEditorWorkflow;
...
/**
 * Panel that contains the Lot Workflow
 * @author Medes-IMPS
 */
public class LotFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, LotFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	LotEditorWorkflow editorWorkflow;
	 ...
	 */
	public LotFormPanel(EpicamRequestFactory requestFactory, String entityId,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new LotEditorWorkflow(requestFactory,
