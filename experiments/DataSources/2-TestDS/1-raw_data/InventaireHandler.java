...
/**
 * A data handler for the Inventaire beans 
 * @author Medes-IMPS
 */
public class InventaireHandler {
	...
	public Inventaire findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public Inventaire getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(Inventaire entity, boolean isNew) {
		...
		if (entity != null) {
			...
			List<DetailInventaire> invae = entity.getDetails();
			if (invae != null) {
				for (DetailInventaire invaeItem : invae) {
					handlerHelper.prepare(invaeItem);
				}
			}
	...
	/**
	 * Lists the entities of type Inventaire
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of inventaire
	 */
	@Transactional(readOnly = true)
	public List<Inventaire> listInventaire(String sortProperty,
			boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<Inventaire> beans = dao.load(sortProperty, sortOrder, junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<Inventaire> listInventaire(int i, int j, String sortProperty,
			boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<Inventaire> beans = dao.load(i, j, sortProperty, sortOrder,
				junction);
	...
	/**
	 * Lists the non affected entities of type Inventaire	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<Inventaire> listNonAffectedInventaire(int i, int j,
		...
		List<Inventaire> beans = dao.loadNonAffected(i, j, sortProperty,
	...
	public List<Inventaire> listNonAffectedInventaire(int i, int j,
		...
		return listNonAffectedInventaire(i, j, sortProperty, sortOrder, null,
				property);
	}

	/**
	 * Used when Inventaire is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of Inventaire non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<Inventaire> listNonAffectedInventaireReverse(int i, int j,
			String sortProperty, boolean sortOrder, ImogJunction criterions,
			String property) {
		...
		List<Inventaire> beans = dao.loadNonAffectedReverse(i, j, sortProperty,
				sortOrder, property, junction);
	...
	public List<Inventaire> listNonAffectedInventaireReverse(int i, int j,
			String sortProperty, boolean sortOrder, String property) {
		return listNonAffectedInventaireReverse(i, j, sortProperty, sortOrder,
				null, property);
	}

	/**
	 * Gets an empty list of Inventaire	
	 * @return an empty list of Inventaire
	 */
	@Transactional(readOnly = true)
	public List<Inventaire> getInventaireEmptyList() {
		return new ArrayList<Inventaire>();
	}

	/**
	 * Counts the number of inventaire in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countInventaire() {
		return countInventaire(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countInventaire(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected inventaire entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedInventaire(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedInventaire(String property) {
		return countNonAffectedInventaire(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedInventaireReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedInventaireReverse(String property) {
		return countNonAffectedInventaireReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<Inventaire> entities) {
		if (entities != null) {
			for (Inventaire entity : entities)
				delete(entity);
		}
	}
	...
	/**
	 * Lists the entities of type Inventaire for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<Inventaire> listForCsv(String sortProperty, boolean sortOrder,
		...
		List<Inventaire> beans = dao.load(sortProperty, sortOrder, junction);
		List<Inventaire> securedBeans = filter.<Inventaire> toSecure(beans);
		return securedBeans;
	}
