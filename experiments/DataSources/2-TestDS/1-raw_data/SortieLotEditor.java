...
/**
 * Editor that provides the UI components that allow a SortieLotProxy to be viewed and edited
 * @author MEDES-IMPS
 */
public class SortieLotEditor extends Composite
		implements
			Editor<SortieLotProxy>,
			HasEditorDelegate<SortieLotProxy>,
			HasEditorErrors<SortieLotProxy> {

	interface Binder extends UiBinder<Widget, SortieLotEditor> {
	}
	...
	private EditorDelegate<SortieLotProxy> delegate;

	private SortieLotProxy editedValue; //Not used by the editor
	 ...
	 */
	public SortieLotEditor(EpicamRequestFactory factory, boolean hideButtons) {
	 ...
	 * @param factory the application request factory
	 */
	public SortieLotEditor(EpicamRequestFactory factory) {
		this(factory, false);
	}
	...
	private void setFieldEditAccess() {
		...
		/* Description section widgets visibility */
		if (!AccessManager.canEditSortieLotDescription())
			descriptionSection.setVisible(false);
	 ...
	 */
	public void setRequestContextForListEditors(SortieLotRequest ctx) {
	}
	...
	/**
	 * Gets the SortieLotProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities
	 * @return
	 */
	public SortieLotProxy getEditedValue() {
		return editedValue;
	}

	/**
	 * Sets the SortieLotProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities	 
	 * @param editedValue 
	 */
	public void setEditedValue(SortieLotProxy editedValue) {
	...
	@Override
	public void setDelegate(EditorDelegate<SortieLotProxy> delegate) {
