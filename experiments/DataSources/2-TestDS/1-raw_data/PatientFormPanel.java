...
import org.imogene.epicam.client.ui.workflow.PatientEditorWorkflow;
...
/**
 * Panel that contains the Patient Workflow
 * @author Medes-IMPS
 */
public class PatientFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, PatientFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	PatientEditorWorkflow editorWorkflow;
	 ...
	 */
	public PatientFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new PatientEditorWorkflow(requestFactory,
	 ...
	 * @param entityId the id of the entity to be managed by the workflow. null if an entity is being created	 
	 */
	public PatientFormPanel(EpicamRequestFactory requestFactory, String entityId) {
