 ...
 * @author MEDES-IMPS
 */
public class ExamenATBCloner {

	public static ExamenATBBck cloneEntity(ExamenATB entity) {
		ExamenATBBck bck = new ExamenATBBck();
		...
		bck.setDateExamen(entity.getDateExamen());
