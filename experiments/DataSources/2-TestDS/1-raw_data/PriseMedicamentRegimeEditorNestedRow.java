 ...
 * @author MEDES-IMPS
 */
public class PriseMedicamentRegimeEditorNestedRow extends Composite
		implements
	...
	interface Binder
			extends
				UiBinder<Widget, PriseMedicamentRegimeEditorNestedRow> {
	}
	 ...
	 */
	public PriseMedicamentRegimeEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//medicament.setLabel(NLS.constants().priseMedicamentRegime_field_medicament(), HasHorizontalAlignment.ALIGN_RIGHT);
		medicament.setLabelWidth("0px");
		//quantite.setLabel(NLS.constants().priseMedicamentRegime_field_quantite(), HasHorizontalAlignment.ALIGN_RIGHT);
		quantite.setLabelWidth("0px");
		//quantiteUnite.setLabel(NLS.constants().priseMedicamentRegime_field_quantiteUnite(), HasHorizontalAlignment.ALIGN_RIGHT);
		quantiteUnite.setLabelWidth("0px");
