 ...
 * @author MEDES-IMPS
 */
public class SortieLotEditorNestedRow extends Composite
		implements
			Editor<SortieLotProxy>,
			HasEditorDelegate<SortieLotProxy>,
			HasEditorErrors<SortieLotProxy> {

	interface Binder extends UiBinder<Widget, SortieLotEditorNestedRow> {
	}
	 ...
	 */
	public SortieLotEditorNestedRow(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	public void properties() {
		...
		//CDT.setLabel(NLS.constants().sortieLot_field_cDT(), HasHorizontalAlignment.ALIGN_RIGHT);
		CDT.setLabelWidth("0px");
		// the value of CDT affects the value of other fields
		CDT.notifyChanges(requestFactory.getEventBus());
		//lot.setLabel(NLS.constants().sortieLot_field_lot(), HasHorizontalAlignment.ALIGN_RIGHT);
		lot.setLabelWidth("0px");
		//quantite.setLabel(NLS.constants().sortieLot_field_quantite(), HasHorizontalAlignment.ALIGN_RIGHT);
