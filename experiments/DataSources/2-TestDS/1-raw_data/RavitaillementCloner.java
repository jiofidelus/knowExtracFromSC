 ...
 * @author MEDES-IMPS
 */
public class RavitaillementCloner {

	public static RavitaillementBck cloneEntity(Ravitaillement entity) {
		RavitaillementBck bck = new RavitaillementBck();
		...
		if (entity.getDetails() != null) {
			...
			for (DetailRavitaillement i : entity.getDetails()) {
				builder.append(i.getId()).append(";");
			}
			bck.setDetails(builder.toString());
		}
		return bck;
	}
}
