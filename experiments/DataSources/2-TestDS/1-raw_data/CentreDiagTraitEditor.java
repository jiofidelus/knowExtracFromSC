...
/**
 * Editor that provides the UI components that allow a CentreDiagTraitProxy to be viewed and edited
 * @author MEDES-IMPS
 */
public class CentreDiagTraitEditor extends Composite
		implements
			Editor<CentreDiagTraitProxy>,
			HasEditorDelegate<CentreDiagTraitProxy>,
			HasEditorErrors<CentreDiagTraitProxy> {

	interface Binder extends UiBinder<Widget, CentreDiagTraitEditor> {
	}
	...
	private EditorDelegate<CentreDiagTraitProxy> delegate;

	private CentreDiagTraitProxy editedValue; //Not used by the editor
	 ...
	 */
	public CentreDiagTraitEditor(EpicamRequestFactory factory,
			boolean hideButtons) {
	...
	private void properties() {
		...
		descriptionSection.setGroupTitle(NLS.constants()
				.centreDiagTrait_group_description());
		code.setLabel(NLS.constants().centreDiagTrait_field_code());
		region.setLabel(NLS.constants().centreDiagTrait_field_region());
		...
		districtSante.setLabel(NLS.constants()
				.centreDiagTrait_field_districtSante());
		nom.setLabel(NLS.constants().centreDiagTrait_field_nom());
		description.setLabel(NLS.constants()
				.centreDiagTrait_field_description());

		/* Adresse section widgets */
		adresseSection.setGroupTitle(NLS.constants()
				.centreDiagTrait_group_adresse());
		libelle.setLabel(NLS.constants().centreDiagTrait_field_libelle());
		libelle.addItem(EpicamEnumConstants.CENTREDIAGTRAIT_LIBELLE_DOMICILE,
				NLS.constants().centreDiagTrait_libelle_domicile_option());
		libelle.addItem(EpicamEnumConstants.CENTREDIAGTRAIT_LIBELLE_BUREAU, NLS
				.constants().centreDiagTrait_libelle_bureau_option());
		libelle.addItem(EpicamEnumConstants.CENTREDIAGTRAIT_LIBELLE_AUTRE, NLS
				.constants().centreDiagTrait_libelle_autre_option());
		complementAdresse.setLabel(NLS.constants()
				.centreDiagTrait_field_complementAdresse());
		quartier.setLabel(NLS.constants().centreDiagTrait_field_quartier());
		ville.setLabel(NLS.constants().centreDiagTrait_field_ville());
		codePostal.setLabel(NLS.constants().centreDiagTrait_field_codePostal());
		coordonnees.setLabel(NLS.constants()
				.centreDiagTrait_field_coordonnees());
		lieuxDits.setLabel(NLS.constants().centreDiagTrait_field_lieuxDits());
	...
	private void setFieldReadAccess() {
		...
		if (!AccessManager.canReadCentreDiagTraitAdresse())
	...
	private void setFieldEditAccess() {
		...
		/* Description section widgets visibility */
		if (!AccessManager.canEditCentreDiagTraitDescription())
			descriptionSection.setVisible(false);

		/* Adresse section widgets visibility */
		if (!AccessManager.canEditCentreDiagTraitAdresse())
			adresseSection.setVisible(false);
	 ...
	 */
	public void setRequestContextForListEditors(CentreDiagTraitRequest ctx) {
	}
	...
	/**
	 * Gets the CentreDiagTraitProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities
	 * @return
	 */
	public CentreDiagTraitProxy getEditedValue() {
		return editedValue;
	}

	/**
	 * Sets the CentreDiagTraitProxy that is edited in the Workflow
	 * Not used by the editor
	 * Temporary storage used to transmit the proxy to related entities	 
	 * @param editedValue 
	 */
	public void setEditedValue(CentreDiagTraitProxy editedValue) {
	...
	@Override
	public void setDelegate(EditorDelegate<CentreDiagTraitProxy> delegate) {
