...
import org.imogene.epicam.client.ui.workflow.DepartPersonnelEditorWorkflow;
...
/**
 * Panel that contains the DepartPersonnel Workflow
 * @author Medes-IMPS
 */
public class DepartPersonnelFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, DepartPersonnelFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	DepartPersonnelEditorWorkflow editorWorkflow;
	 ...
	 */
	public DepartPersonnelFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new DepartPersonnelEditorWorkflow(
