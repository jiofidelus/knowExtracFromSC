...
import org.imogene.epicam.client.ui.workflow.ExamenBiologiqueEditorWorkflow;
...
/**
 * Panel that contains the ExamenBiologique Workflow
 * @author Medes-IMPS
 */
public class ExamenBiologiqueFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, ExamenBiologiqueFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	ExamenBiologiqueEditorWorkflow editorWorkflow;
	 ...
	 */
	public ExamenBiologiqueFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new ExamenBiologiqueEditorWorkflow(
