...
import org.imogene.epicam.client.ui.workflow.RendezVousEditorWorkflow;
...
/**
 * Panel that contains the RendezVous Workflow
 * @author Medes-IMPS
 */
public class RendezVousFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, RendezVousFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	RendezVousEditorWorkflow editorWorkflow;
	 ...
	 */
	public RendezVousFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new RendezVousEditorWorkflow(requestFactory,
