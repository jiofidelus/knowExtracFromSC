...
/**
 * A data handler for the LaboratoireReference beans 
 * @author Medes-IMPS
 */
public class LaboratoireReferenceHandler {
	...
	public LaboratoireReference findById(String entityId) {
	 ...
	 */
	@Transactional(readOnly = true)
	public LaboratoireReference getById(String entityId) {
	 ...
	 */
	@Transactional
	public void save(LaboratoireReference entity, boolean isNew) {
	...
	/**
	 * Lists the entities of type LaboratoireReference
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 * @return list of laboratoireReference
	 */
	@Transactional(readOnly = true)
	public List<LaboratoireReference> listLaboratoireReference(
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<LaboratoireReference> beans = dao.load(sortProperty, sortOrder,
				junction);
	 ...
	 */
	@Transactional(readOnly = true)
	public List<LaboratoireReference> listLaboratoireReference(int i, int j,
			String sortProperty, boolean sortOrder) {

		ImogActor actor = HttpSessionUtil.getCurrentUser();
		ImogJunction junction = createFilterJuntion(actor);

		List<LaboratoireReference> beans = dao.load(i, j, sortProperty,
				sortOrder, junction);
	...
	/**
	 * Lists the non affected entities of type LaboratoireReference	
	 * @param i first index to retrieve
	 * @param j nb of items to retrieve
	 * @param sortProperty the property used to sort the collection
	 * @param sortOrder true for an ascendant sort
	 ...
	 */
	@Transactional(readOnly = true)
	public List<LaboratoireReference> listNonAffectedLaboratoireReference(
		...
		List<LaboratoireReference> beans = dao.loadNonAffected(i, j,
	...
	public List<LaboratoireReference> listNonAffectedLaboratoireReference(
			int i, int j, String sortProperty, boolean sortOrder,
			String property) {
		return listNonAffectedLaboratoireReference(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Used when LaboratoireReference is involved in a Relation 1 <-> 1 
	 * Association and is the ReverseRelationField of the Relation
	 * Return all instance of LaboratoireReference non affected
	 ...
	 */
	@Transactional(readOnly = true)
	public List<LaboratoireReference> listNonAffectedLaboratoireReferenceReverse(
			int i, int j, String sortProperty, boolean sortOrder,
			ImogJunction criterions, String property) {
		...
		List<LaboratoireReference> beans = dao.loadNonAffectedReverse(i, j,
				sortProperty, sortOrder, property, junction);
	...
	public List<LaboratoireReference> listNonAffectedLaboratoireReferenceReverse(
			int i, int j, String sortProperty, boolean sortOrder,
			String property) {
		return listNonAffectedLaboratoireReferenceReverse(i, j, sortProperty,
				sortOrder, null, property);
	}

	/**
	 * Gets an empty list of LaboratoireReference	
	 * @return an empty list of LaboratoireReference
	 */
	@Transactional(readOnly = true)
	public List<LaboratoireReference> getLaboratoireReferenceEmptyList() {
		return new ArrayList<LaboratoireReference>();
	}

	/**
	 * Counts the number of laboratoireReference in the database
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countLaboratoireReference() {
		return countLaboratoireReference(null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countLaboratoireReference(ImogJunction criterions) {
	...
	/**
	 * Counts the number of non affected laboratoireReference entities in the database
	 * @param property the property which is not affected
	 * @param criterion request criteria
	 * @return the count
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedLaboratoireReference(String property,
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedLaboratoireReference(String property) {
		return countNonAffectedLaboratoireReference(property, null);
	}
	 ...
	 */
	@Transactional(readOnly = true)
	public Long countNonAffectedLaboratoireReferenceReverse(String property,
			ImogJunction criterions) {
	...
	@Transactional(readOnly = true)
	public Long countNonAffectedLaboratoireReferenceReverse(String property) {
		return countNonAffectedLaboratoireReferenceReverse(property, null);
	}
	 ...
	 */
	@Transactional
	public void delete(Set<LaboratoireReference> entities) {
		if (entities != null) {
			for (LaboratoireReference entity : entities)
				delete(entity);
		}
	}
	 ...
	 */
	@Transactional
	public void delete(LaboratoireReference entity) {
	...
	/**
	 * Lists the entities of type LaboratoireReference for the CSV export  
	 */
	@Transactional(readOnly = true)
	public List<LaboratoireReference> listForCsv(String sortProperty,
			boolean sortOrder, String nom_francais, String nom_english,
			String nature) {
		...
		List<LaboratoireReference> beans = dao.load(sortProperty, sortOrder,
				junction);
		List<LaboratoireReference> securedBeans = filter
				.<LaboratoireReference> toSecure(beans);
		return securedBeans;
	}
	 ...
	 * @param dao the LaboratoireReference Dao
	 */
	public void setDao(LaboratoireReferenceDao dao) {
		this.dao = dao;
	}
