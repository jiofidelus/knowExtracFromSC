...
/**
 * Filter panel to filter the DistrictSante entries
 * @author MEDES-IMPS
 */
public class DistrictSanteFilterPanel extends ImogFilterPanel {
	...
	public DistrictSanteFilterPanel() {
		super();
		setFieldReadAccess();
	}
	...
	public void createFilterWidgets() {
		...
		nomFilterBox.setFilterLabel(NLS.constants().districtSante_field_nom());
	...
	public List<FilterCriteria> getFilterCriteria() {
		...
		nomCrit.setFieldDisplayName(NLS.constants().districtSante_field_nom());
