...
/**
 * Filter panel to filter the OutBox entries
 * @author MEDES-IMPS
 */
public class OutBoxFilterPanel extends ImogFilterPanel {
	...
	public void createFilterWidgets() {
		...
		messageFilterBox.setFilterLabel(NLS.constants().outBox_field_message());
	...
	public List<FilterCriteria> getFilterCriteria() {
		...
		messageCrit.setFieldDisplayName(NLS.constants().outBox_field_message());
