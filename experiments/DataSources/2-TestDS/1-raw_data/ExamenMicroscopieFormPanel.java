...
import org.imogene.epicam.client.ui.workflow.ExamenMicroscopieEditorWorkflow;
...
/**
 * Panel that contains the ExamenMicroscopie Workflow
 * @author Medes-IMPS
 */
public class ExamenMicroscopieFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, ExamenMicroscopieFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	ExamenMicroscopieEditorWorkflow editorWorkflow;
	 ...
	 */
	public ExamenMicroscopieFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new ExamenMicroscopieEditorWorkflow(
	...
	/**
	 * Setter to inject a LaboratoireReference value into the workflow and the editor
	 * @param value the value to be injected
	 * @param isLocked true if relation field shall be locked (non editable)
	 */
	public void setLaboratoireReference(LaboratoireReferenceProxy value,
			boolean isLocked) {
		editorWorkflow.setLaboratoireReference(value, isLocked);
	}
	 ...
	 */
	public void setLaboratoireReference(LaboratoireReferenceProxy value) {
		setLaboratoireReference(value, false);
	}
	/**
	...
	public void setCasTb(CasTuberculoseProxy value, boolean isLocked) {
		editorWorkflow.setCasTb(value, isLocked);
	}
