...
import org.imogene.epicam.client.ui.workflow.RegimeEditorWorkflow;
...
/**
 * Panel that contains the Regime Workflow
 * @author Medes-IMPS
 */
public class RegimeFormPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, RegimeFormPanel> {
	}

	@UiField(provided = true)
	WrapperPanel wrapperPanel;
	@UiField(provided = true)
	RegimeEditorWorkflow editorWorkflow;
	 ...
	 */
	public RegimeFormPanel(EpicamRequestFactory requestFactory,
		...
		if (entityId != null) {
			if (parent == null)
				editorWorkflow = new RegimeEditorWorkflow(requestFactory,
	 ...
	 * @param entityId the id of the entity to be managed by the workflow. null if an entity is being created	 
	 */
	public RegimeFormPanel(EpicamRequestFactory requestFactory, String entityId) {
